...
TIP: 新しいRailsアプリには、事前設定済みのDev Container開発環境が付属しています。これは、Railsを最初に使う最も早い方法です。手順については、[Dev Containerガイド](getting_started_with_devcontainer.html)を参照してください。
...
|.rubocop.yml| このファイルには、RuboCopの設定が含まれます。|

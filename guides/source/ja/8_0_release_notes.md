...
* [Propshaft](https://github.com/rails/propshaft)がデフォルトになった
* [認証機能ジェネレータ](https://github.com/rails/rails/issues/50446)

このリリースノートでは、主な変更点のみを取り上げています。バグ修正や変更点については、Changelogを参照するか、GitHubのRailsリポジトリにある[コミット一覧](https://github.com/rails/rails/commits/8-0-stable)を確認してください。
